...
import { IoChevronDown, IoEnterOutline, IoAddCircle } from "react-icons/io5";
import {
        ...
        <span className="flex items-center justify-between">
          ...
          <Dropdown backdrop="blur">
            ...
            <DropdownMenu aria-label="Static Actions">
              <DropdownItem
                key="docx"
                startContent={<RiFileWord2Fill className="w-5 h-5" />}
              >
                Upload Doc
              </DropdownItem>
              <DropdownItem
                key="one_drive"
                startContent={<GrOnedrive className="w-5 h-5" />}
              >
                One Drive
              </DropdownItem>
              <DropdownItem
                key="g_drive"
                startContent={<FaGoogleDrive className="w-5 h-5" />}
              >
                Google Drive
              </DropdownItem>
              <DropdownItem
                key="create_new"
                onPress={onOpen}
                startContent={<IoAddCircle className="w-6 h-6" />}
              >
                Create New
              </DropdownItem>
            </DropdownMenu>
